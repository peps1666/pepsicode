...
**File:** `D:\Desktop\pepsicode\py-src\pepsicode\context_manager.py`
**Lines:** 51-53
**Risk:** **Medium**
...
## Finding 4: O(n虏) Compaction Loop

**File:** `D:\Desktop\pepsicode\py-src\pepsicode\context_manager.py`
**Lines:** 176-214
**Risk:** **Medium**

**Problem:** The `while` loop calls `estimate_messages_tokens(filtered)` on every iteration, which itself iterates over all messages (O(n)). Combined with the outer loop that removes one message at a time, this becomes O(n虏) in the number of messages.
...
**File:** `D:\Desktop\pepsicode\py-src\pepsicode\cost_tracker.py`
**Lines:** 11-56
**Risk:** **Low**
...
def _load_pricing() -> dict[str, dict[str, float]]:
    pricing_file = PEPSI_CODE_DIR / "model_pricing.json"
...
**File:** `D:\Desktop\pepsicode\py-src\pepsicode\memory.py`
...
```python
# pepsicode/utils/tokens.py (new module)
def estimate_tokens(text: str) -> int:
    ...

# memory.py
from pepsicode.utils.tokens import estimate_tokens
...
**File:** `D:\Desktop\pepsicode\py-src\pepsicode\sub_agents.py`
...
**File:** `D:\Desktop\pepsicode\py-src\pepsicode\task_tracker.py`
**Lines:** 237-261
**Risk:** **Low**
...
**File:** `D:\Desktop\pepsicode\py-src\pepsicode\tools\web_fetch.py`
**Lines:** 55-64
**Risk:** **Medium**
...
**File:** `D:\Desktop\pepsicode\py-src\pepsicode\tools\web_search.py`
**Lines:** 41-45
**Risk:** **Medium**
...
**File:** `D:\Desktop\pepsicode\py-src\pepsicode\api_retry.py`
**Lines:** 212-255
**Risk:** **High**
...
**File:** `D:\Desktop\pepsicode\py-src\pepsicode\async_context.py`
**Lines:** 115-174
**Risk:** **Medium**
...
**File:** `D:\Desktop\pepsicode\py-src\pepsicode\state.py`
**Lines:** 72-78
**Risk:** **Low**
...
**File:** `D:\Desktop\pepsicode\py-src\pepsicode\skills.py`
**Lines:** 70-75
**Risk:** **Low**
...
**File:** `D:\Desktop\pepsicode\py-src\pepsicode\tooling.py`
**Lines:** 124-129
**Risk:** **Medium**
