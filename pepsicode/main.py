...
def _render_quick_start() -> str:
    ...
    return """
>> Quick Start Guide:
   [E] Edit files:     edit_file.py or patch_file.py
   [S] Search code:    /grep <pattern> or grep_files tool
   [R] Run commands:   /cmd <command> or run_command tool
   [T] Think deeply:   Use sequential_thinking MCP tool
   [V] View skills:    /skills
   [H] Get help:       /help

>> Try saying:
   "Analyze this project structure"
   "Implement XX feature using TDD"
   "Systematically debug this bug"
