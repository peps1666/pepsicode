...
def test_import_core():
    ...
    try:
        from pepsicode import agent_loop, config, permissions, prompt, skills
        from pepsicode import tooling, mcp, history, workspace
        return True
...
def test_import_new_features():
    ...
    try:
        from pepsicode import state, cost_tracker, context_manager
        from pepsicode import api_retry, task_tracker, memory
        from pepsicode import poly_commands, async_context, sub_agents
        from pepsicode import auto_mode, hooks, session, install
        return True
    except ImportError as e:
...
def test_store_state():
    ...
    from pepsicode.state import Store, AppState, create_app_store
...
def test_poly_commands():
    ...
    from pepsicode.poly_commands import (
...
def test_auto_mode():
    ...
    from pepsicode.auto_mode import (
...
def test_session_persistence():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        with patch("pepsicode.session.SESSIONS_DIR", tmp_path / "sessions"), \
